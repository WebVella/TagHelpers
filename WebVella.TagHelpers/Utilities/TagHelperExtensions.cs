...
namespace WebVella.TagHelpers.Utilities
{
	...
	{
		internal static void AddCssClass(this TagHelperOutput output, string cssClass)
		{
			var processed = false;
		...
		internal static void AddCssClass(this TagHelperOutput output, List<string> cssClasses)
		{
			var processed = false;
			if (output.Attributes.ContainsName("class"))
			{
