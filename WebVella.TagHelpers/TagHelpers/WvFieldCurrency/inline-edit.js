...
function CurrencyInlineEditGenerateSelectors(fieldId, fieldName,config) {
...
function CurrencyInlineEditPreEnableCallback(fieldId, fieldName,config) {
...
function CurrencyInlineEditPreDisableCallback(fieldId, fieldName,config) {
	var selectors = CurrencyInlineEditGenerateSelectors(fieldId, fieldName,config);
	...
	$(selectors.editWrapper + " .save").on("click", function (event) {
		...
		$.ajax({
			...
			success: function (response) {
				if (response.success) {
					CurrencyInlineEditInitSuccessCallback(response, fieldId, fieldName,config);
				}
				else {
					CurrencyInlineEditInitErrorCallback(response, fieldId, fieldName,config);
				}
			},
...
function CurrencyInlineEditInitErrorCallback(response, fieldId, fieldName,config) {
	var selectors = CurrencyInlineEditGenerateSelectors(fieldId, fieldName,config);
