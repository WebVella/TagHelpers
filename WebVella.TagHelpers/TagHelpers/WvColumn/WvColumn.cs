...
namespace WebVella.TagHelpers.TagHelpers
{
	...
	public class WvColumn : TagHelper
	{
		...
		public WvFlexSelfAlignType FlexSelftAlign { get; set; } = WvFlexSelfAlignType.None;
		...
		public override Task ProcessAsync(TagHelperContext context, TagHelperOutput output)
		{
			...
			if (FlexSelftAlign != WvFlexSelfAlignType.None)
			{
				switch (FlexSelftAlign)
				{
					case WvFlexSelfAlignType.Start:
						classList.Add($"align-self-start");
						break;
					case WvFlexSelfAlignType.Center:
						classList.Add($"align-self-center");
						break;
					case WvFlexSelfAlignType.End:
