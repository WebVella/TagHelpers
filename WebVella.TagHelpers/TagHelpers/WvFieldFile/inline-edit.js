...
function FileInlineEditGenerateSelectors(fieldId, fieldName, config) {
...
function FileInlineEditPreDisableCallback(fieldId, fieldName, config) {
	var selectors = FileInlineEditGenerateSelectors(fieldId, fieldName, config);
...
function FileInlineEditInit(fieldId, fieldName, config) {
	...
	$(selectors.editWrapper + " .cancel").on("click", function (event) {
		event.stopPropagation();
		event.preventDefault();
		FileInlineEditPreDisableCallback(fieldId, fieldName, config);
	});
	//Save inline changes
		...
		if (newValue === oldValue) {
			...
			$.ajax({
				...
				success: function (response) {
					if (response.success) {
						FileInlineEditInitSuccessCallback(response, fieldId, fieldName, config);
					}
					else {
...
function FileInlineEditInitErrorCallback(response, fieldId, fieldName, config) {
	var selectors = FileInlineEditGenerateSelectors(fieldId, fieldName, config);
